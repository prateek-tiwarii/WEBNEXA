                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">                            
                        <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:scale-105 rounded-lg shadow-2xl p-3 min-h-max">
                            <div className="m-2 text-justify text-sm">
                                <h4 className="font-semibold my-4 text-lg md:text-2xl text-center mb-4 h-12">EtherEase</h4>
                                <p className="text-md font-medium leading-5 h-auto md:h-48">
                                EtherEase is committed to simplifying Web 3.0 adoption for non-technical users and freelancing teams by offering 
                                a user-friendly platform, enhanced security, and a simplified tokenization process. Through collaborative 
                                problem-solving and rigorous testing, we've successfully overcome challenges to provide a seamless and secure 
                        ...
                        <div className="bg-white transition-all ease-in-out duration-400 overflow-hidden text-gray-700 hover:scale-105 rounded-lg shadow-2xl p-3">
                            <div className="m-2 text-justify text-sm">
                                ...
                                <p className="text-md font-medium leading-5 h-auto md:h-48">
                                    ...
                                    The School Management Portal (SMP) is a tool that can help educational institutions of all kinds 
                                    manage their administrative tasks, automate processes, and streamline communication between teachers, students, parents, and administrators. 
                        ...
                        <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:scale-105 rounded-lg shadow-2xl p-3">
                            <div className="m-2 text-justify text-sm">
                            <h4 className="font-semibold my-4 text-lg md:text-2xl text-center mb-4 h-12"> GDSC ABESIT</h4>
                                <p className="text-md font-medium leading-5 h-auto md:h-48">
                                The GDSC ABESIT platform is a dynamic hub designed to empower students with cutting-edge tech knowledge, 
                                hands-on projects, and a collaborative learning environment. It connects aspiring developers, designers, 
                                and tech enthusiasts to industry trends, workshops, hackathons, and mentorship opportunities.
                                </p>
                                <div className="flex justify-center my-4">
                                    <Link to="/get-demo" className="text-white bg-blue-900 hover:bg-blue-800 inline-flex items-center justify-center w-full px-6 py-3 my-4 text-lg shadow-xl rounded-xl">
                                        Schedule Demo
